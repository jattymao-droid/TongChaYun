/** Survey themeJson helpers for H5 fill pages (keep in sync with ruoyi-ui). */
...
export function normalizeSurveyTheme(raw) {
  ...
  t.successTitle = String(t.successTitle || '\u63d0\u4ea4\u6210\u529f').slice(0, 40)
  t.successMsg = String(t.successMsg || '\u611f\u8c22\u60a8\u7684\u53c2\u4e0e').slice(0, 200)
