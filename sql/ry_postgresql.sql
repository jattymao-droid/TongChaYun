...
create table sys_dept (
  dept_id int8 generated by default as identity not null,
...
create table sys_user (
  user_id int8 generated by default as identity not null,
...
create table sys_post (
  post_id int8 generated by default as identity not null,
...
create table sys_role (
  role_id int8 generated by default as identity not null,
...
create table sys_menu (
  menu_id int8 generated by default as identity not null,
...
create table sys_oper_log (
  oper_id int8 generated by default as identity not null,
...
create table sys_dict_type (
  dict_id int8 generated by default as identity not null,
...
create table sys_dict_data (
  dict_code int8 generated by default as identity not null,
...
create table sys_config (
  config_id int4 generated by default as identity not null,
...
create table sys_logininfor (
  info_id int8 generated by default as identity not null,
...
create table sys_job (
  job_id int8 generated by default as identity not null,
...
create table sys_job_log (
  job_log_id int8 generated by default as identity not null,
...
create table sys_notice (
  notice_id int4 generated by default as identity not null,
...
create table sys_notice_read (
  read_id int8 generated by default as identity not null,
...
create table gen_table (
  table_id int8 generated by default as identity not null,
...
create table gen_table_column (
  column_id int8 generated by default as identity not null,
  table_id int8,
...
-- Reset identity sequences after seed data
select setval(pg_get_serial_sequence('sys_dept', 'dept_id'), greatest(coalesce((select max(dept_id) from sys_dept), 1), 199));
select setval(pg_get_serial_sequence('sys_user', 'user_id'), greatest(coalesce((select max(user_id) from sys_user), 1), 99));
select setval(pg_get_serial_sequence('sys_post', 'post_id'), greatest(coalesce((select max(post_id) from sys_post), 1), 99));
select setval(pg_get_serial_sequence('sys_role', 'role_id'), coalesce((select max(role_id) from sys_role), 1), true);
select setval(pg_get_serial_sequence('sys_menu', 'menu_id'), greatest(coalesce((select max(menu_id) from sys_menu), 1), 1999));
select setval(pg_get_serial_sequence('sys_oper_log', 'oper_id'), greatest(coalesce((select max(oper_id) from sys_oper_log), 1), 99));
select setval(pg_get_serial_sequence('sys_dict_type', 'dict_id'), greatest(coalesce((select max(dict_id) from sys_dict_type), 1), 99));
select setval(pg_get_serial_sequence('sys_dict_data', 'dict_code'), greatest(coalesce((select max(dict_code) from sys_dict_data), 1), 99));
select setval(pg_get_serial_sequence('sys_config', 'config_id'), greatest(coalesce((select max(config_id) from sys_config), 1), 99));
select setval(pg_get_serial_sequence('sys_logininfor', 'info_id'), greatest(coalesce((select max(info_id) from sys_logininfor), 1), 99));
select setval(pg_get_serial_sequence('sys_job', 'job_id'), greatest(coalesce((select max(job_id) from sys_job), 1), 99));
select setval(pg_get_serial_sequence('sys_job_log', 'job_log_id'), greatest(coalesce((select max(job_log_id) from sys_job_log), 1), 9));
select setval(pg_get_serial_sequence('sys_notice', 'notice_id'), greatest(coalesce((select max(notice_id) from sys_notice), 1), 9));
select setval(pg_get_serial_sequence('sys_notice_read', 'read_id'), greatest(coalesce((select max(read_id) from sys_notice_read), 1), 0));
select setval(pg_get_serial_sequence('gen_table', 'table_id'), greatest(coalesce((select max(table_id) from gen_table), 1), 0));
select setval(pg_get_serial_sequence('gen_table_column', 'column_id'), greatest(coalesce((select max(column_id) from gen_table_column), 1), 0));
